...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div
      key={book._id}
      className="bg-red-200 border-2 border-red-400 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl shadow-red-100"
    >
      <h2 className="absolute top-1 right-1 px-4 py-1 bg-red-300 rounded-lg">
        {book.publishYear}
      </h2>
      {/* no need to show the id <h4 className="my-4 text-gray-500">{book._id}</h4> */}
